...
function ReactQuiz() {
    ...
    useEffect(function () {
        fetch('https://api.jsonbin.io/v3/qs/64cbecedb89b1e2299cac48a').then(res => res.json()).then(data => dispatch({ type: "dataRecieved", payload: data.record.questions })).catch(() => dispatch({ type: "dataFailed" }))
    }, [])
